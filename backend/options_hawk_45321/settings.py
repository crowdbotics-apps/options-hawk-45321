"""
Django settings for options_hawk_45321 project.
...
ROOT_URLCONF = 'options_hawk_45321.urls'
...
WSGI_APPLICATION = 'options_hawk_45321.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "options_hawk_45321 API",
    "DESCRIPTION": "API documentation for options_hawk_45321 App",
    "VERSION": "v1",
}
